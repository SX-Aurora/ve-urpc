...
void ve_urpc_fini(urpc_peer_t *up)
{
	int err;
        ...
        urpc_set_receiver_flags(&up->recv, urpc_get_receiver_flags(&up->recv) | URPC_FLAG_EXITED);
        urpc_set_sender_flags(&up->send, urpc_get_sender_flags(&up->send) | URPC_FLAG_EXITED);
